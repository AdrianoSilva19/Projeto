...
The exponential growth of the science produced can be measured by the number of articles and citations that are been made through these years\cite{Artigo1},
this is self-evident in the field of omics where the data produced almost grew by forty times\cite{Artigo2}.
Aligned with the growing need to have easily accessible, well structured and cured data has brought to light some challenges.
